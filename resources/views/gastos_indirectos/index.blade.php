        ...
        <div class="relative p-6 flex-auto">
            <div class="grid grid-cols-8 gap-8">
              ...
              <div class="col-span-8">
                  ...
                  <input type="number" name="clave" id="clave" placeholder="100" maxlength="20" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('clave') }}" required>
                  <label id="error_clave" name="error_clave" class="hidden text-base font-normal text-red-500" >Por favor ingresar una clave</label>
                </div>
              
              <div class="col-span-8">
                  <label id="label_nombre" for="nombre" class="block text-sm font-medium text-gray-700">Nombre *</label>
                  <input type="text" name="nombre" id="nombre" placeholder="Nombre" maxlength="40" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('nombre') }}" required>
...
@if(session('eliminar')=='error')
  <script>
    Swal.fire({
      icon: 'error',
      title: '¡Oops... !',
      html: 'Este gasto tiene relación con otro registro.<br> No es posible eliminarlo.'
    });
  </script>
@endif

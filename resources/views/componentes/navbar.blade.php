<nav class="sticky top-0 bg-gray-900 ">
    ...
    <!-- Mobile menu button-->
    <button type="button" @click="sidebar = true" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
    ...
    <div class="ml-3 relative z-40" x-data="{ open: false }">
        ...
        <p class="block px-4 py-2 text-sm text-gray-700 border-b-2 ">¡Bienvenid@ {{Auth::user()->name}}!</p>

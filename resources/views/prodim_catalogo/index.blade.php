...
<div class="flex flex-row">
    ...
    <h1 class="text-xl font-bold ml-2">Catalogo Prodim</h1>
</div>
        ...
        @foreach ($catalogo as $item)
          <tr>
              ...
              <td>
                ...
                <form action="{{ route('prodimCatalogo.destroy', $item->id_prodim_catalogo) }}" method="POST" class="form-eliminar" >
                  <div>
                  <a type="button"  href="{{ route('prodimCatalogo.edit', $item->id_prodim_catalogo) }}" class="bg-white text-blue-500 p-2 rounded rounded-lg">Editar</a>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-id">
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
      ...
      <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <!--body-->
        <form action="{{ route('prodimCatalogo.store') }}" method="POST" id="formulario" name="formulario">
          @csrf
          @method('POST')
